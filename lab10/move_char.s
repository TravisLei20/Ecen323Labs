...
DISPLAY_LOCATION:
    # Display the character at the old location
    addi t1, x0, SPACE_CHAR                    	# Always write space to old location
    sw t1, 0(s3)                                # Write the character to the VGA

    # Display the character at the current location
    addi t1, x0, SMILE_FACE                    	# Always write smile face to new location
